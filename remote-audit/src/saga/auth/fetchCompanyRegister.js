...
const fetchCompanyRegister = (info) => {
    ...
    formData.append('company_registration_number', info.companyRegistrationNumber)
    formData.append('company_licence_registration_date', info.companyLicenceRegistrationDate)
