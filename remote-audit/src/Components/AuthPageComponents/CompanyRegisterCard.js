...
const CompanyRegisterCardLayout = ({info, fetchCompanyRegister}) => {
    ...
    const [companyLicenceRegistrationDate, setCompanyLicenceRegistrationDate] = useState('')
        ...
        <div style={styles.wrapper}>
            <RegisterCard elevation={4}>
                ...
                <TextField
                    ...
                    onChange={(e)=>setCompanyLicenceRegistrationDate(e.target.value)}
                    variant="standard"
                    style={{
                        marginBottom: 15,
                        width: 420
                ...
                />
                <Button onClick={()=>registerHandler()} variant="outlined" size="small" style={{paddingTop: 6}}>
                    Зарегистрироваться
                </Button>
            </RegisterCard>
        </div>
