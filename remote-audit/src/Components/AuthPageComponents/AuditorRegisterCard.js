...
import {fetchAuditorCompanyRegister, fetchCompanyRegister} from "../../store/actions/authActions";
...
const AuditorRegisterCardLayout = ({fetchAuditorCompanyRegister}) => {
    ...
    const [auditorCompanyRegistrationDate,setAuditorCompanyRegistrationDate] = useState('')
    const [auditorCompanyRegistrationNumber, setAuditorCompanyRegistrationNumber] = useState('')
    const [auditorCompanyLicenceNumber, setAuditorCompanyLicenceNumber] = useState('')
    const [auditorCompanyLicenceRegistrationDate, setAuditorCompanyLicenceRegistrationDate] = useState('')
    const [auditorCompanyLicenceLicenceOrganisation, setAuditorCompanyLicenceLicenceOrganisation] = useState('')
        ...
        <div style={styles.wrapper}>
            <RegisterCard elevation={4}>
                ...
                <TextField
                    ...
                    onChange={(e)=>setAuditorCompanyRegistrationDate(e.target.value)}
                    variant="standard"
                    style={{
                        marginBottom: 15,
                        width: 420
                ...
                <TextField
                    ...
                    onChange={(e)=>setAuditorCompanyRegistrationNumber(e.target.value)}
                    variant="standard"
                    style={{
                        marginBottom: 15,
                        width: 420
                ...
                <TextField
                    ...
                    onChange={(e)=>setAuditorCompanyLicenceNumber(e.target.value)}
                    variant="standard"
                    style={{
                        marginBottom: 15,
                        width: 420
                ...
                <TextField
                    ...
                    onChange={(e)=>setAuditorCompanyLicenceRegistrationDate(e.target.value)}
                    variant="standard"
                    style={{
                        marginBottom: 15,
                        width: 420
                ...
                <TextField
                    ...
                    onChange={(e)=>setAuditorCompanyLicenceLicenceOrganisation(e.target.value)}
                    variant="standard"
                    style={{
                        marginBottom: 15,
                        width: 420
                ...
                />
                <Button variant="outlined" size="small" style={{paddingTop: 6}} onClick={()=>registerHandler()}>
                    Зарегистрироваться
                </Button>
            </RegisterCard>
        </div>
