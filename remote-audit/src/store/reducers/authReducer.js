    ...
    switch (action.type) {
        ...
        case SET_AUDITOR_PROFILE:
            return {
                ...
                licenceOrganisation:
                    action.info.auditor_company_licence_licenceOrganisation,
                licenceNumber: action.info.auditor_company_licence_number,
                licenceRegistrationDate:
                    action.info.auditor_company_licence_registration_date,
                location: action.info.auditor_company_location,
                companyName: action.info.auditor_company_name,
                companyRegistrationDate:
                    action.info.auditor_company_registration_date,
                companyRegistrationNumber:
                    action.info.auditor_company_registration_number,
                email: action.info.email,
            };
